		...
		init:						function(path)
										{
											...
											AllFirms2 = new HashMap(); //BTree<String,Firm>()
											firmTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
											bankTree = new HashMap(); //BTree<String,ArrayList<Bankrupcy>>()											
											bankruptTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
											goingConcernTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
											sicTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
											categoryTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
											quarterTree = new HashMap(); //BTree<Integer,ArrayList<Firm>>()
											BeforeTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
											DuringTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
											AfterTree = new HashMap(); //BTree<String,ArrayList<Firm>>()
										},
										
		doBankrupcy:		function(filename)
										{
											var tree = new HashMap(); //new BTree<String,ArrayList<Bankrupcy>>();
											var b; //Bankrupcy
											var text="";
											var v = []; //new String[26];		
											var values = [];
											...
											try
											{
												...
												fs.readFile(filename, function(err, data) {
													...
													{
														v = str.split(",");	 
														b = new Bankrupcy().createNewBankrupcy(
											...
											{
        								console.log('There was an error reading bankrupcy database.');
